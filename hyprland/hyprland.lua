...
local browser     = "firefox -p Home --name firefox-home"
local workBrowser = "firefox -p Work --name firefox-work"
...
hl.bind(altMod .. " + B", hl.dsp.exec_cmd(workBrowser))
...
hl.window_rule({ match = { class = "^firefox-home$" }, workspace = "2" })
hl.window_rule({ match = { class = "^firefox-work$" }, workspace = "4" })
